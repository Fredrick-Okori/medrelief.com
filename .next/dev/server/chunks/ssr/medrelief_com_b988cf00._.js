...
function Contact() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$medrelief$2e$com$2f$app$2f$actions$2f$data$3a$319747__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["submitContact"])(formDataToSubmit);
            if (result.success) {
                setSubmitted(true);
                setFormData({
                    firstName: "",
...
//# sourceMappingURL=medrelief_com_b988cf00._.js.map