...
import { MessageCircle, Check, Phone, Clock, Users, CalendarDays } from "lucide-react"
...
export default function ServiceDetailView({ serviceId }: ServiceDetailViewProps) {
              ...
              >
                ...
                <div className="flex flex-wrap gap-4 pt-4">
                  <motion.button
                    ...
                    className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-semibold transition-colors shadow-lg cursor-pointer"
          ...
          >
            <div className="max-w-3xl mx-auto text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <motion.button
                  onClick={handleCall}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white px-8 py-4 rounded-lg font-semibold transition-colors border-2 border-white/20 cursor-pointer"
